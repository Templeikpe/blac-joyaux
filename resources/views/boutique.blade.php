...
<div class="max-w-7xl mx-auto border border-gray-400 min-h-screen">
    ...
    <section class="text-center mt-8">
        ...
        <h2 class="text-3xl md:text-5xl font-bold mt-2">
            Nos deux collections de sacs made in Cote d'Ivoire
        </h2>
    </section>

    <!-- COLLECTIONS -->
    <section class="mt-14 px-8 pb-14">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-[2px] bg-gray-400">
            ...
            <div class="relative h-[400px] md:h-[600px] overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=800&q=80"
                     class="w-full h-full object-cover duration-500 group-hover:scale-110">
                <div class="absolute inset-0 bg-black/35"></div>
                <div class="absolute bottom-10 left-8 text-white">
