    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="space-y-3 mb-10">
            ...
            <details class="bg-white rounded-xl px-6 py-4 cursor-pointer shadow-sm">
                ...
                <p class="text-gray-500 text-xs mt-3 leading-relaxed">
                    Nous recommandons le sac <strong>Sac Bureau Gold</strong> de la Collection DO (85 000 FCFA) ou le sac <strong>Joyau de Bla Noir</strong> (50 000 FCFA). Les deux sont élégants et adaptés au quotidien professionnel.
                </p>
            </details>
