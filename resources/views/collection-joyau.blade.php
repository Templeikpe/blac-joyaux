...
<section class="relative text-white text-center py-16 px-6"
         style="background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=1400&q=80');background-size:cover;background-position:center;min-height:220px">
    ...
    <div class="max-w-5xl mx-auto">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&q=80" alt="Sac" class="w-full h-44 object-cover">
                <div class="p-3">
            ...
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400&q=80" alt="Sac" class="w-full h-44 object-cover">
                <div class="p-3">
                    <p class="text-xs text-gray-400 mb-1">Sac à main – Nouvelle version</p>
            ...
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1591561954557-26941169b49e?w=400&q=80" alt="Sac" class="w-full h-44 object-cover">
                <div class="p-3">
                    <p class="text-xs text-gray-400 mb-1">Sac à main – Nouvelle version</p>
                    <p class="font-bold text-xs mb-1" style="color:#3D2314">Bleu avec bijoux doré</p>
            ...
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                ...
                <div class="p-3">
                    <p class="text-xs text-gray-400 mb-1">Sac à main – Nouvelle version</p>
                    <p class="font-bold text-xs mb-1" style="color:#3D2314">Imprimé peau de serpent</p>
                    <p class="font-bold text-sm mb-3" style="color:#3D2314">70 000 CFA</p>
                    <a href="/fiche-produit" class="block text-center text-white text-xs py-2 rounded" style="background:#3D2314">En savoir plus</a>
                </div>
            </div>
