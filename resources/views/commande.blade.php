        ...
        <div>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="text-xs font-medium mb-1 block" style="color:#3D2314">Prénom</label>
                        <input type="text" placeholder="Votre prénom"
                               class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-orange-400 bg-white">
                    </div>
                    <div>
                        <label class="text-xs font-medium mb-1 block" style="color:#3D2314">Nom</label>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Quartier, commune, ville..."
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none focus:border-orange-400 bg-white">
                </div>

                <div>
                    <label class="text-xs font-medium mb-1 block" style="color:#3D2314">Ville</label>
                    <select class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none bg-white">
                ...
                <div>
                    <label class="text-xs font-medium mb-1 block" style="color:#3D2314">Délai de livraison</label>
                    <select class="w-full px-4 py-3 rounded-xl border border-gray-200 text-sm outline-none bg-white">
                        <option>1 jour (Abidjan uniquement)</option>
        ...
        <div>
            ...
            <div class="bg-white rounded-2xl p-4 shadow-sm mb-4">
                <div class="flex items-center gap-3 mb-3 pb-3 border-b">
                    <img src="https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=100&q=80"
                         alt="Sac" class="w-14 h-14 object-cover rounded-xl">
                    <div class="flex-1">
                        <p class="text-xs font-semibold" style="color:#3D2314">Sac à main Noir</p>
                        <p class="text-xs text-gray-400">Joyau de Bla · Qté : 1</p>
                    </div>
                    <p class="font-bold text-sm" style="color:#3D2314">50 000 FCFA</p>
                </div>
                <div class="flex items-center gap-3">
                    <img src="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=100&q=80"
                         alt="Sac" class="w-14 h-14 object-cover rounded-xl">
                    <div class="flex-1">
                        <p class="text-xs font-semibold" style="color:#3D2314">Sac Cuir Marron</p>
                        <p class="text-xs text-gray-400">Collection DO · Qté : 1</p>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-4 shadow-sm mb-6">
                <div class="space-y-3 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span style="color:#3D2314">120 000 FCFA</span>
                    </div>
                    <div class="flex justify-between">
            ...
            <a href="https://wa.me/2250700775537?text=Bonjour, je souhaite passer commande sur Blac Joyaux. Total : 120 000 FCFA"
               target="_blank"
               class="block text-center text-white font-semibold py-4 rounded-xl text-sm hover:opacity-90 transition"
...
<div id="confirmation" class="hidden fixed inset-0 bg-black/50 z-50 flex items-center justify-center px-6">
    <div class="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-2xl">
        ...
        <h2 class="text-2xl font-bold mb-3" style="color:#3D2314">Commande confirmée !</h2>
        <p class="text-gray-500 text-sm mb-2">Numéro de commande : <span class="font-bold" style="color:#E8820C">#BJ2026001</span></p>
        <p class="text-gray-500 text-sm mb-6">Vous serez contacté sous peu pour la livraison.</p>
        <a href="https://wa.me/2250700775537?text=Bonjour, ma commande #BJ2026001 est confirmée. Total : 120 000 FCFA"
           target="_blank"
           class="block text-white font-semibold py-3 rounded-xl text-sm mb-3"
           style="background:#25D366">
            💬 Confirmer sur WhatsApp
        </a>
        <a href="/" class="block text-sm font-medium py-3 rounded-xl border-2" style="border-color:#3D2314;color:#3D2314">
            Retour à l'accueil
        </a>
    </div>
</div>
