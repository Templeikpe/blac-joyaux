...
<head>
    ...
    <title>DO Dominique — Blac Joyaux</title>
...
<section class="relative text-white text-center py-16 px-6"
         style="background-image:linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)),url('https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=1400&q=80');background-size:cover;background-position:center;min-height:220px">
    <h1 class="text-4xl font-bold mb-4 uppercase">DO - Dominique</h1>
    <p class="text-gray-200 max-w-lg mx-auto text-sm leading-relaxed">
        La collection DO incarne l'élégance et la prestance de la femme ivoirienne moderne. Des pièces uniques qui allient style contemporain et héritage africain.
    </p>
</section>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&q=80" alt="Sac" class="w-full h-44 object-cover">
                <div class="p-3">
                    <p class="text-xs text-gray-400 mb-1">Sac à main – Collection DO</p>
                    <p class="font-bold text-xs mb-1" style="color:#3D2314">Cuir Marron</p>
                    <p class="font-bold text-sm mb-3" style="color:#3D2314">50 000 CFA</p>
                    <a href="/fiche-produit" class="block text-center text-white text-xs py-2 rounded" style="background:#3D2314">En savoir plus</a>
                </div>
            </div>

            <!-- Produit 2 -->
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1575032617751-6ddec2089882?w=400&q=80" alt="Sac" class="w-full h-44 object-cover">
                <div class="p-3">
                    <p class="text-xs text-gray-400 mb-1">Sac à main – Collection DO</p>
                    <p class="font-bold text-xs mb-1" style="color:#3D2314">Croco Lézard</p>
                    <p class="font-bold text-sm mb-3" style="color:#3D2314">70 000 CFA</p>
                    <a href="/fiche-produit" class="block text-center text-white text-xs py-2 rounded" style="background:#3D2314">En savoir plus</a>
                </div>
            </div>
            ...
            <!-- Produit 3 -->
            <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm">
                <img src="https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&q=80" alt="Sac" class="w-full h-44 object-cover">
                <div class="p-3">
                    <p class="text-xs text-gray-400 mb-1">Sac à main – Collection DO</p>
                    <p class="font-bold text-xs mb-1" style="color:#3D2314">Cuir Marron (avec boucle)</p>
                    <p class="font-bold text-sm mb-3" style="color:#3D2314">50 000 CFA</p>
                    <a href="/fiche-produit" class="block text-center text-white text-xs py-2 rounded" style="background:#3D2314">En savoir plus</a>
                </div>
            </div>
